...
class _TestState extends State<Test> {
  ...
  pressed() async {// 변환하고자 하는 이미지 경로
      ...
      List<Shoes> shoes = [
        Shoes(shoesname: 'Newb Red', price: 100000, image: imageList[0], size: 265, brand: 'newBalance'),
        Shoes(shoesname: 'Newb White', price: 100000, image: imageList[1], size: 255, brand: 'newBalance'),
        Shoes(shoesname: 'NIKE Black', price: 120000, image: imageList[2], size: 265, brand: 'NIKE'),
        Shoes(shoesname: 'NIKE Red', price: 120000, image: imageList[3], size: 255, brand: 'NIKE'),
        Shoes(shoesname: 'Prosp Black', price: 130000, image: imageList[4], size: 265, brand: 'prosPecs'),
        Shoes(shoesname: 'Prosp Red', price: 130000, image: imageList[5], size: 255, brand: 'prosPecs'),
      ];
